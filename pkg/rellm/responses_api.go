...
// ResponsesAPIReq structure used for communication with llm via Responses API
...
// ResponsesAPIResp structure used for communication with llm via Responses API
